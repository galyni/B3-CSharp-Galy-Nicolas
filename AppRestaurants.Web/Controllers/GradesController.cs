...
namespace AppRestaurants.Web.Controllers
{
    public class GradesController : Controller
    {
        ...
        public GradesController(RestaurantsContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,Note,DateDerniereVisite,Commentaire,RestaurantID")] Grade grade)
        {
